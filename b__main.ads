...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#ec2d868d#;
   ...
   u00123 : constant Version_32 := 16#4bd4c505#;
   pragma Export (C, u00123, "concrete_client_logicB");
   u00124 : constant Version_32 := 16#4a956a30#;
   ...
   u00126 : constant Version_32 := 16#654e2c4c#;
   pragma Export (C, u00126, "ada__containers__hash_tablesS");
   u00127 : constant Version_32 := 16#c24eaf4d#;
   pragma Export (C, u00127, "ada__containers__prime_numbersB");
   u00128 : constant Version_32 := 16#6d3af8ed#;
   pragma Export (C, u00128, "ada__containers__prime_numbersS");
   u00129 : constant Version_32 := 16#59e971b9#;
   pragma Export (C, u00129, "ada__strings__unbounded__hash_case_insensitiveB");
   u00130 : constant Version_32 := 16#210c8daa#;
   pragma Export (C, u00130, "ada__strings__unbounded__hash_case_insensitiveS");
   u00131 : constant Version_32 := 16#eee9c0c6#;
   pragma Export (C, u00131, "ada__strings__hash_case_insensitiveB");
   u00132 : constant Version_32 := 16#f9e6d5c1#;
   pragma Export (C, u00132, "ada__strings__hash_case_insensitiveS");
   u00133 : constant Version_32 := 16#8f637df8#;
   pragma Export (C, u00133, "ada__characters__handlingB");
   u00134 : constant Version_32 := 16#3b3f6154#;
   pragma Export (C, u00134, "ada__characters__handlingS");
   u00135 : constant Version_32 := 16#92f05f13#;
   pragma Export (C, u00135, "ada__strings__maps__constantsS");
   u00136 : constant Version_32 := 16#da8cbe06#;
   pragma Export (C, u00136, "ada__strings__unbounded__auxB");
   u00137 : constant Version_32 := 16#5c293c89#;
   pragma Export (C, u00137, "ada__strings__unbounded__auxS");
   u00138 : constant Version_32 := 16#28f088c2#;
   pragma Export (C, u00138, "ada__text_ioB");
   u00139 : constant Version_32 := 16#1a9b0017#;
   pragma Export (C, u00139, "ada__text_ioS");
   u00140 : constant Version_32 := 16#84a27f0d#;
   pragma Export (C, u00140, "interfaces__c_streamsB");
   u00141 : constant Version_32 := 16#8bb5f2c0#;
   pragma Export (C, u00141, "interfaces__c_streamsS");
   u00142 : constant Version_32 := 16#431faf3c#;
   pragma Export (C, u00142, "system__file_ioB");
   u00143 : constant Version_32 := 16#53bf6d5f#;
   pragma Export (C, u00143, "system__file_ioS");
   u00144 : constant Version_32 := 16#ee0f26dd#;
   pragma Export (C, u00144, "system__os_libB");
   u00145 : constant Version_32 := 16#d7b69782#;
   pragma Export (C, u00145, "system__os_libS");
   u00146 : constant Version_32 := 16#1a817b8e#;
   pragma Export (C, u00146, "system__stringsB");
   u00147 : constant Version_32 := 16#8a719d5c#;
   pragma Export (C, u00147, "system__stringsS");
   u00148 : constant Version_32 := 16#09511692#;
   pragma Export (C, u00148, "system__file_control_blockS");
   u00149 : constant Version_32 := 16#db6c0ef5#;
   pragma Export (C, u00149, "datatypesB");
   u00150 : constant Version_32 := 16#06e9bbbb#;
   pragma Export (C, u00150, "datatypesS");
   u00151 : constant Version_32 := 16#ddcf5bc4#;
   pragma Export (C, u00151, "gnat__sha512B");
   u00152 : constant Version_32 := 16#440abe20#;
   pragma Export (C, u00152, "gnat__sha512S");
   u00153 : constant Version_32 := 16#9056b5d4#;
   pragma Export (C, u00153, "gnat__secure_hashesB");
   u00154 : constant Version_32 := 16#02159d7e#;
   pragma Export (C, u00154, "gnat__secure_hashesS");
   u00155 : constant Version_32 := 16#e1b34a50#;
   pragma Export (C, u00155, "gnat__secure_hashes__sha2_64B");
   u00156 : constant Version_32 := 16#2e99e110#;
   pragma Export (C, u00156, "gnat__secure_hashes__sha2_64S");
   u00157 : constant Version_32 := 16#45efda4c#;
   pragma Export (C, u00157, "gnat__byte_swappingB");
   u00158 : constant Version_32 := 16#ad3648f2#;
   pragma Export (C, u00158, "gnat__byte_swappingS");
   u00159 : constant Version_32 := 16#8d52f87a#;
   pragma Export (C, u00159, "system__byte_swappingS");
   u00160 : constant Version_32 := 16#144f90e7#;
   pragma Export (C, u00160, "gnat__secure_hashes__sha2_commonB");
   u00161 : constant Version_32 := 16#6b1dbe15#;
   pragma Export (C, u00161, "gnat__secure_hashes__sha2_commonS");
   u00162 : constant Version_32 := 16#1767a79e#;
   pragma Export (C, u00162, "system__assertionsB");
   u00163 : constant Version_32 := 16#3943a0ae#;
   pragma Export (C, u00163, "system__assertionsS");
   u00164 : constant Version_32 := 16#06cb2950#;
   pragma Export (C, u00164, "system__strings__stream_opsB");
   u00165 : constant Version_32 := 16#55d4bd57#;
   pragma Export (C, u00165, "system__strings__stream_opsS");
   u00166 : constant Version_32 := 16#a71b0af5#;
   pragma Export (C, u00166, "ada__streams__stream_ioB");
   u00167 : constant Version_32 := 16#31fc8e02#;
   pragma Export (C, u00167, "ada__streams__stream_ioS");
   u00168 : constant Version_32 := 16#a4624963#;
   pragma Export (C, u00168, "protocolB");
   u00169 : constant Version_32 := 16#4c2f0774#;
   pragma Export (C, u00169, "protocolS");
   u00170 : constant Version_32 := 16#fd83e873#;
   pragma Export (C, u00170, "system__concat_2B");
   u00171 : constant Version_32 := 16#f66e5bea#;
   pragma Export (C, u00171, "system__concat_2S");
   u00172 : constant Version_32 := 16#608e2cd1#;
   pragma Export (C, u00172, "system__concat_5B");
   u00173 : constant Version_32 := 16#7390cf14#;
   pragma Export (C, u00173, "system__concat_5S");
   u00174 : constant Version_32 := 16#932a4690#;
   pragma Export (C, u00174, "system__concat_4B");
   u00175 : constant Version_32 := 16#8aaaa71a#;
   pragma Export (C, u00175, "system__concat_4S");
   u00176 : constant Version_32 := 16#2b70b149#;
   pragma Export (C, u00176, "system__concat_3B");
   u00177 : constant Version_32 := 16#ffbed09f#;
   pragma Export (C, u00177, "system__concat_3S");
   u00178 : constant Version_32 := 16#46899fd1#;
   pragma Export (C, u00178, "system__concat_7B");
   u00179 : constant Version_32 := 16#0809d725#;
   pragma Export (C, u00179, "system__concat_7S");
   u00180 : constant Version_32 := 16#a83b7c85#;
   pragma Export (C, u00180, "system__concat_6B");
   u00181 : constant Version_32 := 16#2609a188#;
   pragma Export (C, u00181, "system__concat_6S");
   u00182 : constant Version_32 := 16#d0432c8d#;
   pragma Export (C, u00182, "system__img_enum_newB");
   u00183 : constant Version_32 := 16#95828afa#;
   pragma Export (C, u00183, "system__img_enum_newS");
   u00184 : constant Version_32 := 16#4b37b589#;
   pragma Export (C, u00184, "system__val_enumB");
   u00185 : constant Version_32 := 16#4fd4ceaf#;
   pragma Export (C, u00185, "system__val_enumS");
   u00186 : constant Version_32 := 16#e5480ede#;
   pragma Export (C, u00186, "ada__strings__fixedB");
   u00187 : constant Version_32 := 16#a86b22b3#;
   pragma Export (C, u00187, "ada__strings__fixedS");
   u00188 : constant Version_32 := 16#dbf24c7a#;
   pragma Export (C, u00188, "gnat__string_splitB");
   u00189 : constant Version_32 := 16#00425e4a#;
   pragma Export (C, u00189, "gnat__string_splitS");
