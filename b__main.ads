...
package ada_main is
   ...
   u00115 : constant Version_32 := 16#35c26b14#;
   ...
   u00376 : constant Version_32 := 16#889c3aa8#;
   pragma Export (C, u00376, "gtkada__builderB");
   u00377 : constant Version_32 := 16#054d62aa#;
   pragma Export (C, u00377, "gtkada__builderS");
   u00378 : constant Version_32 := 16#eca7d2aa#;
   pragma Export (C, u00378, "gtk__handlersB");
   u00379 : constant Version_32 := 16#4ec738e6#;
   pragma Export (C, u00379, "gtk__handlersS");
   u00380 : constant Version_32 := 16#1767a79e#;
   pragma Export (C, u00380, "system__assertionsB");
   u00381 : constant Version_32 := 16#3943a0ae#;
   pragma Export (C, u00381, "system__assertionsS");
   u00382 : constant Version_32 := 16#53dfc0e9#;
   pragma Export (C, u00382, "gtk__marshallersB");
   u00383 : constant Version_32 := 16#33f6213e#;
   pragma Export (C, u00383, "gtk__marshallersS");
   u00384 : constant Version_32 := 16#f59df1f8#;
   pragma Export (C, u00384, "gtkada__handlersS");
   u00385 : constant Version_32 := 16#d0432c8d#;
   pragma Export (C, u00385, "system__img_enum_newB");
   u00386 : constant Version_32 := 16#95828afa#;
   pragma Export (C, u00386, "system__img_enum_newS");
   u00387 : constant Version_32 := 16#5e196e91#;
   pragma Export (C, u00387, "ada__containersS");
   u00388 : constant Version_32 := 16#654e2c4c#;
   pragma Export (C, u00388, "ada__containers__hash_tablesS");
   u00389 : constant Version_32 := 16#c24eaf4d#;
   pragma Export (C, u00389, "ada__containers__prime_numbersB");
   u00390 : constant Version_32 := 16#6d3af8ed#;
   pragma Export (C, u00390, "ada__containers__prime_numbersS");
   u00391 : constant Version_32 := 16#217daf40#;
   pragma Export (C, u00391, "ada__strings__unbounded__hashB");
   u00392 : constant Version_32 := 16#4f2a3177#;
   pragma Export (C, u00392, "ada__strings__unbounded__hashS");
   u00393 : constant Version_32 := 16#06cb2950#;
   pragma Export (C, u00393, "system__strings__stream_opsB");
   u00394 : constant Version_32 := 16#55d4bd57#;
   pragma Export (C, u00394, "system__strings__stream_opsS");
   u00395 : constant Version_32 := 16#a71b0af5#;
   pragma Export (C, u00395, "ada__streams__stream_ioB");
   u00396 : constant Version_32 := 16#31fc8e02#;
   pragma Export (C, u00396, "ada__streams__stream_ioS");
   u00397 : constant Version_32 := 16#5de653db#;
   pragma Export (C, u00397, "system__communicationB");
   u00398 : constant Version_32 := 16#edaed9e8#;
   pragma Export (C, u00398, "system__communicationS");
   u00399 : constant Version_32 := 16#a4624963#;
   pragma Export (C, u00399, "protocolB");
   u00400 : constant Version_32 := 16#4c2f0774#;
   pragma Export (C, u00400, "protocolS");
   u00401 : constant Version_32 := 16#fd83e873#;
   pragma Export (C, u00401, "system__concat_2B");
   u00402 : constant Version_32 := 16#f66e5bea#;
   pragma Export (C, u00402, "system__concat_2S");
   u00403 : constant Version_32 := 16#608e2cd1#;
   pragma Export (C, u00403, "system__concat_5B");
   u00404 : constant Version_32 := 16#7390cf14#;
   pragma Export (C, u00404, "system__concat_5S");
   u00405 : constant Version_32 := 16#932a4690#;
   pragma Export (C, u00405, "system__concat_4B");
   u00406 : constant Version_32 := 16#8aaaa71a#;
   pragma Export (C, u00406, "system__concat_4S");
   u00407 : constant Version_32 := 16#2b70b149#;
   pragma Export (C, u00407, "system__concat_3B");
   u00408 : constant Version_32 := 16#ffbed09f#;
   pragma Export (C, u00408, "system__concat_3S");
   ...
   u00525 : constant Version_32 := 16#671f37d7#;
