...
\vspace{1em}
\begin{enumerate}
	\item Mit diesem Kontextmenü kann man Kontakte zu seiner Kontaktliste hinzufügen.
	\item Hier kann sich 
...
Im Übersichtsfenster bekommt man Informationen über den aktuellen Status seiner Kontaktliste und kann einen Chatpartner zum chatten auswählen.

\begin{minipage}{\linewidth}
	\centering
	\includegraphics[width=0.5\linewidth]{img/client_overview.png}
...
\begin{enumerate}
	...
	\item Hier kann man seinen momentanen Onlinestatus einstellen.
	\item Mit Hilfe dieses Textfensters kann man seine Kontaktliste durchsuchen.
	\item Unter diesem Punkt werden alle Kontakte angezeigt, die online sind.
	\item Unter diesem Punkt werden alle Kontakte angezeigt, die offline sind.
\end{enumerate}
